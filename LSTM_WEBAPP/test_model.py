...
model = tf.keras.models.load_model(os.path.join(os.path.dirname(__file__),"lstm_model.h5"))
lookback = 10 
...
plt.xlabel('period')
plt.plot(date_values_bi, y_y_test, label='actual')
plt.axvline(date_values_bi[-1], color='red')
